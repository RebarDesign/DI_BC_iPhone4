function init() {
			...
			var Sal4 = new OpenLayers.Layer.Image(
				'Sal 4',
				'../img/4FloorPlan.jpg',
			...
			function sendToUp() {
				...
				$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/up/4/" + roomId + "/"+id
						  })
						   .done(function( data ) {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
					...
					//if (vectorLayer.styleMap.styles == "selected"){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/stop/4/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
				...
				for(var f=0;f<vectorLayer.features.length;f++){
					...
					//if (vectorLayer.styleMap.styles == "selected"){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/down/4/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
			...
			function sendToHoriz() {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/horizontalB/4/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
			...
			function sendToClosed() {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/closedB/4/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
			...
			function sendToEnergy() {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/energyB/4/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
			...
			var B4019Data = new Array(
			/*R Nb[0]:*/ "B4019",/*Name[1]:*/"Kontor 4",/*Nb Bl[2]:*/ 7,/* X[3]:*/ 130 ,/*Y[4]:*/ 210 ,/*Bl Dr[5]:*/ 16 ,/*1st Bl[6]*/ 147);
				
					createBlind ( 'blind147', '147' , B4019Data[3] , B4019Data[4] , B4019Data[0]);
					createBlind ( 'blind148', '148' , B4019Data[3], B4019Data[4] - B4019Data[5] , B4019Data[0]);
					createBlind ( 'blind149', '149' , B4019Data[3], B4019Data[4] - B4019Data[5]*2  , B4019Data[0]);
					createBlind ( 'blind150', '150' , B4019Data[3], B4019Data[4] - B4019Data[5]*3 , B4019Data[0]);
					createBlind ( 'blind151', '151' , B4019Data[3], B4019Data[4] - B4019Data[5]*4, B4019Data[0]);
					createBlind ( 'blind152', '152' , B4019Data[3], B4019Data[4] - B4019Data[5]*5, B4019Data[0]);
					createBlind ( 'blind153', '153' , B4019Data[3], B4019Data[4] - B4019Data[5]*6, B4019Data[0]); //Width. Height//
					createLabel ( B4019Data[1] , B4019Data[3] - 65, B4019Data[4] - 53, B4019Data[2], B4019Data[6], 30 , 6);
					
			
			
			////Add layers on map===================/////
			map.addLayers([Sal4, vectorLayer, textLabels]);
