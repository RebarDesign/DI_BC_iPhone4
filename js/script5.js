function init() {
			...
			var Sal5 = new OpenLayers.Layer.Image(
				'Sal 5',
				'../img/5FloorPlan.jpg',
			...
			function sendToUp() {
				...
				$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/up/5/" + roomId + "/"+id
						  })
						   .done(function( data ) {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
					...
					//if (vectorLayer.styleMap.styles == "selected"){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/stop/5/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
				...
				for(var f=0;f<vectorLayer.features.length;f++){
					...
					//if (vectorLayer.styleMap.styles == "selected"){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/down/5/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
			...
			var B5006Data = new Array(
			/*R Nb[0]:*/ "B5006",/*Name[1]:*/"Kontor 5",/*Nb Bl[2]:*/ 7,/* X[3]:*/ 10 ,/*Y[4]:*/ 210 ,/*Bl Dr[5]:*/ 16 ,/*1st Bl[6]*/ 154);
				
					createBlind ( 'blind154', '154' , B5006Data[3] , B5006Data[4] , B5006Data[0]);
					createBlind ( 'blind155', '155' , B5006Data[3], B5006Data[4] - B5006Data[5] , B5006Data[0]);
					createBlind ( 'blind156', '156' , B5006Data[3], B5006Data[4] - B5006Data[5]*2  , B5006Data[0]);
					createBlind ( 'blind157', '157' , B5006Data[3], B5006Data[4] - B5006Data[5]*3 , B5006Data[0]);
					createBlind ( 'blind158', '158' , B5006Data[3], B5006Data[4] - B5006Data[5]*4, B5006Data[0]);
					createBlind ( 'blind159', '159' , B5006Data[3], B5006Data[4] - B5006Data[5]*5, B5006Data[0]);
					createBlind ( 'blind160', '160' , B5006Data[3], B5006Data[4] - B5006Data[5]*6, B5006Data[0]); //Width. Height//
					createLabel ( B5006Data[1] , B5006Data[3] - 65, B5006Data[4] - 43, B5006Data[2], B5006Data[6], 30 , 6);
					
			
			
			////Add layers on map===================/////
			map.addLayers([Sal5, vectorLayer, textLabels]);
