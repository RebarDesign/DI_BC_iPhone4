function init() {
			...
			var Sal3 = new OpenLayers.Layer.Image(
				'Sal 3',
				'../img/3FloorPlan.jpg',
			...
			function sendToUp() {
				...
				$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/up/3/" + roomId + "/"+id
						  })
						   .done(function( data ) {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
					...
					//if (vectorLayer.styleMap.styles == "selected"){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/stop/3/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
				...
				for(var f=0;f<vectorLayer.features.length;f++){
					...
					//if (vectorLayer.styleMap.styles == "selected"){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/down/3/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
			...
			function sendToHoriz() {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/horizontalB/3/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
			...
			function sendToClosed() {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/closedB/3/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
			...
			function sendToEnergy() {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/energyB/3/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
			...
			var B3019Data = new Array(
			/*R Nb[0]:*/ "B3019",/*Name[1]:*/"Kontor 3",/*Nb Bl[2]:*/ 7,/* X[3]:*/ 270 ,/*Y[4]:*/ 210 ,/*Bl Dr[5]:*/ 16 ,/*1st Bl[6]*/ 140);
				
					createBlind ( 'blind140', '140' , B3019Data[3] , B3019Data[4] , B3019Data[0]);
					createBlind ( 'blind141', '141' , B3019Data[3], B3019Data[4] - B3019Data[5] , B3019Data[0]);
					createBlind ( 'blind142', '142' , B3019Data[3], B3019Data[4] - B3019Data[5]*2  , B3019Data[0]);
					createBlind ( 'blind143', '143' , B3019Data[3], B3019Data[4] - B3019Data[5]*3 , B3019Data[0]);
					createBlind ( 'blind144', '144' , B3019Data[3], B3019Data[4] - B3019Data[5]*4, B3019Data[0]);
					createBlind ( 'blind145', '145' , B3019Data[3], B3019Data[4] - B3019Data[5]*5, B3019Data[0]);
					createBlind ( 'blind146', '146' , B3019Data[3], B3019Data[4] - B3019Data[5]*6, B3019Data[0]); //Width. Height//
					createLabel ( B3019Data[1] , B3019Data[3] - 65, B3019Data[4] - 43, B3019Data[2], B3019Data[6], 30 , 6);
					
			
			
			////Add layers on map===================/////
			map.addLayers([Sal3, vectorLayer, textLabels]);
