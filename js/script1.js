			...
			*/
			...
			function sendToUp() {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
					...
					$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/up/1/B1015/"+id
						  })
						   .done(function( data ) {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
					...
					//if (vectorLayer.styleMap.styles == "selected"){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/stop/1/B1015/"+id
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
				...
				for(var f=0;f<vectorLayer.features.length;f++){
					...
					//if (vectorLayer.styleMap.styles == "selected"){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/down/1/B1015/"+id
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
...
/*
			...
			*/
			...
			var roomB1006LabelX = blind1X + 13;
			var roomB1006LabelY = blind1Y - 15;
