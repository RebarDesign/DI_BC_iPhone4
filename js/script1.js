			...
			function sendToHoriz() {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/horizontalB/1/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
			...
			function sendToClosed() {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/closedB/1/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
			...
			function sendToEnergy() {
				...
				for(var f=0;f<vectorLayer.features.length;f++){
						...
						if(vectorLayer.selectedFeatures.indexOf(vectorLayer.features[f])> -1 ){
							...
							$.ajax({
						  type: "GET",
						  url: "http://" + serverIp + ":" + serverPort + "/ServerJAXRS/cmd/energyB/1/" + roomId + "/"+id 
						  })
						   .done(function( data ) {
							   console.log("command sent to server");
							   })
